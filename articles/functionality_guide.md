...
✔ [1.6s] check_assembly() successfully installed isoextract version 0.2.1.0

✔ [197ms] ir_extract_isofiles() finished extracting 2 files/archives

✔ [530ms] ir_read_isofiles() finished reading 2 isotope data files/archives
```
...
``` fansi
✔ [169ms] ir_aggregate_isofiles() aggregated metadata (2) and traces (24.5k,
...
``` fansi
✔ [12ms] ir_get_data() retrieved 24.5k records from the combination of metadata
...
``` fansi
✔ [10ms] ir_get_data() retrieved 25 records from the combination of metadata
...
``` fansi
✔ [152ms] ir_extract_isofiles() finished extracting 1 file/archive
```

``` fansi
✔ [454ms] ir_read_isofiles() finished reading 1 isotope data file/archive
```

``` fansi
✔ [154ms] ir_aggregate_isofiles() aggregated metadata (1) and cycles (102,
...
``` fansi
✔ [132ms] ir_extract_isofiles() finished extracting 4 files/archives
```

``` fansi
✔ [199ms] ir_read_isofiles() finished reading 4 isotope data files/archives
```

``` fansi
✔ [589ms] ir_aggregate_isofiles() aggregated metadata (4) and scans (17.8k,
