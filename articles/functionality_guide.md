...
``` fansi
✔ [157ms] ir_extract_isofiles() finished extracting 2 files/archives
```

``` fansi
✔ [505ms] ir_read_isofiles() finished reading 2 isotope data files/archives
```

``` fansi
✔ [259ms] ir_aggregate_isofiles() aggregated metadata (2) and cycles (192,
...
``` fansi
✔ [335ms] ir_aggregate_isofiles() aggregated metadata (4) and scans (17.8k,
...
``` fansi
✔ [950ms] ir_export_to_excel() exported 2 rows of metadata and 24.5k rows of
