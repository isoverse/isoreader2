...
``` fansi
✔ [264ms] ir_aggregate_isofiles() aggregated metadata (2) and traces (24.5k,
...
``` fansi
✔ [134ms] ir_aggregate_isofiles() aggregated metadata (1) and cycles (102,
...
``` fansi
✔ [368ms] ir_aggregate_isofiles() aggregated metadata (4) and scans (17.8k,
