...
✔ [2.2s] ir_check_isoextract() successfully installed isoextract version
0.2.0.0

✔ [188ms] ir_extract_isofiles() finished extracting 2 files/archives

✔ [188ms] ir_read_isofiles() finished reading 2 isotope data files/archives
```
...
``` fansi
✔ [285ms] ir_aggregate_isofiles() aggregated metadata (2), traces (24.5k,
...
``` fansi
✔ [148ms] ir_extract_isofiles() finished extracting 2 files/archives
```
...
``` fansi
✔ [241ms] ir_aggregate_isofiles() aggregated metadata (2) and cycles (192,
...
``` fansi
✔ [355ms] ir_aggregate_isofiles() aggregated metadata (4) and scans (17.8k,
