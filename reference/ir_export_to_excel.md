...
#> (re-)extraction
#> ✔ [442ms] ir_read_isofiles() finished reading 2 isotope data files/archives
...
#> ✔ [996ms] ir_export_to_excel() exported 2 rows of metadata and 24.5k rows of
#> traces to /tmp/RtmpwrjreS/my_export.xlsx
# }
```
