...
#> ✔ [2ms] ir_copy_examples() copied 7 example files to /tmp/RtmpybFBSg/examples
#> [1] "/tmp/RtmpybFBSg/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/RtmpybFBSg/examples/continuous_flow_gc_example.cf" 
```
