...
#> ✔ [3ms] ir_copy_examples() copied 7 example files to /tmp/RtmpScmt8O/examples
#> [1] "/tmp/RtmpScmt8O/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/RtmpScmt8O/examples/continuous_flow_gc_example.cf" 
```
