...
#> ✔ [3ms] ir_copy_examples() copied 7 example files to /tmp/RtmpVd4PXk/examples
#> [1] "/tmp/RtmpVd4PXk/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/RtmpVd4PXk/examples/continuous_flow_gc_example.cf" 
```
