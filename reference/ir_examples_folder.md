...
#> ✔ [2ms] ir_copy_examples() copied 7 example files to /tmp/Rtmp1XJqn8/examples
#> [1] "/tmp/Rtmp1XJqn8/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/Rtmp1XJqn8/examples/continuous_flow_gc_example.cf" 
```
