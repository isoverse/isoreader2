...
#> ✔ [2ms] ir_copy_examples() copied 7 example files to /tmp/RtmpYh0iAP/examples
#> [1] "/tmp/RtmpYh0iAP/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/RtmpYh0iAP/examples/continuous_flow_gc_example.cf" 
```
