...
#> ✔ [3ms] ir_copy_examples() copied 7 example files to /tmp/RtmpyNUhMZ/examples
#> [1] "/tmp/RtmpyNUhMZ/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/RtmpyNUhMZ/examples/continuous_flow_gc_example.cf" 
```
