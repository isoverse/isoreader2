...
#> ✔ [3ms] ir_copy_examples() copied 7 example files to /tmp/RtmpnGbLq3/examples
#> [1] "/tmp/RtmpnGbLq3/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/RtmpnGbLq3/examples/continuous_flow_gc_example.cf" 
```
