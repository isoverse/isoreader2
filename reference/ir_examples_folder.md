...
#> ✔ [2ms] ir_copy_examples() copied 7 example files to /tmp/RtmpN3WKeq/examples
#> [1] "/tmp/RtmpN3WKeq/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/RtmpN3WKeq/examples/continuous_flow_gc_example.cf" 
```
