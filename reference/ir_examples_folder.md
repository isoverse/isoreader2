...
#> ✔ [3ms] ir_copy_examples() copied 7 example files to /tmp/RtmpSDVXp1/examples
#> [1] "/tmp/RtmpSDVXp1/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/RtmpSDVXp1/examples/continuous_flow_gc_example.cf" 
```
