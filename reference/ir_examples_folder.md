...
#> ✔ [3ms] ir_copy_examples() copied 7 example files to /tmp/RtmpTKTP2r/examples
#> [1] "/tmp/RtmpTKTP2r/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/RtmpTKTP2r/examples/continuous_flow_gc_example.cf" 
```
