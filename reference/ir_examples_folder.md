...
#> ✔ [3ms] ir_copy_examples() copied 7 example files to /tmp/Rtmp305jct/examples
#> [1] "/tmp/Rtmp305jct/examples/continuous_flow_ea_example.dxf"
#> [2] "/tmp/Rtmp305jct/examples/continuous_flow_gc_example.cf" 
```
